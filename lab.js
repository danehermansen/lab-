...
// console.log("Bring an umbrella with a t-shirt");
// }else if (temperature > 60 && rain === true){
// console.log("Bring a raincoat with an umberella");
// }else if (temperature < 60 && rain !== true){
// console.log("Warm coat and no umbrella needed");
// }else if (temperature > 80 && rain !== true){
// console.log("T-shirt and no umbrella needed")};
...
//CODE HERE
// while(score < 7){
// console.log("Your score is not high enough"); score += 1;}
